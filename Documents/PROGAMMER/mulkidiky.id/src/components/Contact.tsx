          ...
          <div className="space-y-12">
            ...
            <div className="glass p-8 rounded-3xl">
              ...
              <div className="space-y-4">
                {['Instagram', 'Youtube', 'Linkedin', 'Github', 'TikTok'].map(social => (
                   <a key={social} href="#" className="flex items-center justify-between p-4 glass rounded-xl hover:bg-white/5 transition-colors group">
